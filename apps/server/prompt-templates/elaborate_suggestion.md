...
- "interesting_properties" are the properties in the User Intent JSON but elaborated for respecting the Car Response Schema JSON (value and label) for example:
    - "trunk_volume" -> "trunk_volume": {
          ...
          value: "A single discorsive value" // This MUST be discorsive and NOT A JSON!
        }.
- "interesting_properties" should be generated using the country of the User Intent JSON for currency, infomrations, prices, availability and unit of measurement.
