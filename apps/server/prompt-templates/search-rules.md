...
2. Suggest EXACTLY 3 real cars available on the User market that match their requirements, use the language of the user to inference it ( Example: for user en-US use the United States market, for user es-ES use the Spanish market, etc.)
