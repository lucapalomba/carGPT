...
|------|------------|----------|---------------|---------|-------|
|      |     ministral-3:3b       |     Ollama     |      4         |    1s   |    Currently the best model for carGPT; I am building around its capabilities. It recognizes languages and models without any special effort.    |
