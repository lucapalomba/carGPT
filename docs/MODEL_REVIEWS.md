...
|      | qwen3:8b       | Ollama   | 5             | 25s     | Good response quality, Fast for 8b model but selected  properties seems not so interesting as Ministral models. It can be approached using thinking for retrieve some generation phase informations |
